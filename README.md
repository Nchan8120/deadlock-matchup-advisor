...
- Win-Rate-Based Recommendations. Suggests strong picks using historical matchup data
- Item-Aware Analysis. Adjusts recommendations based on item builds that mitigate counters
